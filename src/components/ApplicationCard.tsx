...
export function ApplicationCard({ item }: { item: ApplicationArea }) {
  ...
  return (
    <article className="rounded-lg border border-mineral-200 bg-white p-6 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        ...
        {Icon ? (
          <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-forest-50 text-forest-800">
